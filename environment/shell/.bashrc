...
alias a2_navdetach="screen -dmS nav bash -c 'a2 source; a2 nav'"
alias a2_simdliodetach="screen -dmS sim bash -c 'a2 source; a2 sim --dlio' && screen -dmS dlio bash -c 'a2 source; a2 dlio'"
